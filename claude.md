...
### Routes (`config/routes.rb:17`)
- Root: Buckets index (`buckets#index`)
- Session management (sign-in/sign-out)
- Full CRUD for entries
- CRUD for buckets (except destroy)

### Controllers
- **BucketsController**: Manage real and virtual accounts
- **EntriesController**: Create and manage transactions
- **SessionsController**: User authentication

### Current Limitations
- Single currency support (EUR default)
- No budget bucket deletion
- Basic reporting (balance calculations only)
...
- Account associations added (Nov 5, 2025)
- User authentication implemented
- Workflow for income tracking
- Security updates (SQLite3, npm dependencies)
